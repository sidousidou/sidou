...
clear
echo "Katacoda Centos Windows 11 by fb.com/elninosdo"
...
clear
echo "Katacoda Centos Windows 11 by fb.com/elninosdo"
echo Your RDP IP Address is: curl --silent --show-error http://127.0.0.1:4040/api/tunnels | sed -nE 's/.*public_url":"tcp:..([^"]*).*/\1/p'
echo User: Administrator
echo Password: Thuonghai001
echo Script by fb.com/elninosdo
